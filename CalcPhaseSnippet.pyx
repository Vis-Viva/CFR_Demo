"""
A NOTE FOR VIEWERS: Please be aware that there are things below which will be pretty meaningless to you.
I have made zero modifications to this code to make it fully comprehensible from the outside. This would be basically
...
Regardless, some quick clarifications: ll = long long, flt3 = 3-dim float array, int2 = 2-dim int array, etc 
"""
